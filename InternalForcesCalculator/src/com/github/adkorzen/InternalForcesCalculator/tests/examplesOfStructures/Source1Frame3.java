...
public class Source1Frame3 {
	Project p;

	@Before
	public void setUp() {
		p = createSource1Frame3();
	}
	...
	@Test
	public void IsStaticallySolvable_Source1Frame3_ReturnsTrue() {
		boolean condition = p.isStaticallySolvable();
		assertTrue(condition);
	}

	@Test
	public void IsGeometricallyStable_Source1Frame3_ReturnsTrue() {
