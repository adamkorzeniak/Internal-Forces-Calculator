...
public class Source2Frame1 {
	Project p;

	@Before
	public void setUp() {
		p = createSource2Frame1();
	}
	...
	@Test
	public void IsStaticallySolvable_Source2Frame1_ReturnsTrue() {
		boolean condition = p.isStaticallySolvable();
		assertTrue(condition);
	}

	@Test
	public void IsGeometricallyStable_Source2Frame1_ReturnsTrue() {
