...
public class Source7Beam3 {
	Project p;

	@Before
	public void setUp() {
		p = createSource7Beam3();
	}
	...
	@Test
	public void IsStaticallySolvable_Source7Beam3_ReturnsTrue() {
		boolean condition = p.isStaticallySolvable();
		assertTrue(condition);
	}

	@Test
	public void IsGeometricallyStable_Source7Beam3_ReturnsTrue() {
