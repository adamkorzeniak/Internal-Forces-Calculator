...
public class Source1Frame6 {
	Project p;

	@Before
	public void setUp() {
		p = createSource1Frame6();
	}
	...
	@Test
	public void IsStaticallySolvable_Source1Frame6_ReturnsTrue() {
		boolean condition = p.isStaticallySolvable();
		assertTrue(condition);
	}

	@Test
	public void IsGeometricallyStable_Source1Frame6_ReturnsTrue() {
