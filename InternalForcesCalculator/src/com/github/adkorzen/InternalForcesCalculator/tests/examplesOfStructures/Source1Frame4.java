...
public class Source1Frame4 {
	Project p;

	@Before
	public void setUp() {
		p = createSource1Frame4();
	}
	...
	@Test
	public void IsStaticallySolvable_Source1Frame4_ReturnsTrue() {
		boolean condition = p.isStaticallySolvable();
		assertTrue(condition);
	}

	@Test
	public void IsGeometricallyStable_Source1Frame4_ReturnsTrue() {
