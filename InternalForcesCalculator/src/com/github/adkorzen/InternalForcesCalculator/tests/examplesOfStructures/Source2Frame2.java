...
public class Source2Frame2 {
	Project p;

	@Before
	public void setUp() {
		p = createSource2Frame2();
	}
	...
	@Test
	public void IsStaticallySolvable_Source2Frame2_ReturnsTrue() {
		boolean condition = p.isStaticallySolvable();
		assertTrue(condition);
	}

	@Test
	public void IsGeometricallyStable_Source2Frame2_ReturnsTrue() {
