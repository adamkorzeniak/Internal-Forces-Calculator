...
public class Source2Frame4ReleaseOnOtherSideOfNode {
	...
	@Test
	public void IsStaticallySolvable_Source2Frame4ReleaseOnOtherSideOfNode_ReturnsTrue() {
		boolean condition = p.isStaticallySolvable();
		assertTrue(condition);
	}

	@Test
	public void IsGeometricallyStable_Source2Frame4ReleaseOnOtherSideOfNode_ReturnsTrue() {
