...
public class Source1Frame8 {
	Project p;

	@Before
	public void setUp() {
		p = createSource1Frame8();
	}
	...
	@Test
	public void IsStaticallySolvable_Source1Frame8_ReturnsTrue() {
		boolean condition = p.isStaticallySolvable();
		assertTrue(condition);
	}

	@Test
	public void IsGeometricallyStable_Source1Frame8_ReturnsTrue() {
